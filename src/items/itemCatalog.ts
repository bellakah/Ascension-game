...
const ITEMS: ItemDefinition[] = [
  ...
  { id: 'iron_ore', name: 'Minério de Ferro', description: 'Minério bruto extraído de veios rochosos. Pode ser refinado na forja.', icon: '⛏️', category: 'material', rarity: 'common', stackMax: 60, value: 5 },
  { id: 'silver_ore', name: 'Minério de Prata', description: 'Minério claro e raro, procurado por ferreiros e artesãos arcanos.', icon: '◇', category: 'material', rarity: 'uncommon', stackMax: 50, value: 9 },
  { id: 'iron_ingot', name: 'Lingote de Ferro', description: 'Ferro refinado e pronto para fabricação de armas e armaduras.', icon: '▰', category: 'material', rarity: 'uncommon', stackMax: 40, value: 18 },
  ...
  { id: 'oak_wood', name: 'Madeira de Carvalho', description: 'Madeira firme de carvalho jovem. Boa para cabos, cajados e estruturas.', icon: '🪵', category: 'material', rarity: 'common', stackMax: 60, value: 5 },
  { id: 'healing_herb', name: 'Erva-da-Clareira', description: 'Erva medicinal comum encontrada na floresta. Base para poções de vida.', icon: '🌿', category: 'material', rarity: 'common', stackMax: 60, value: 5 },
  { id: 'moonleaf', name: 'Folha Lunar', description: 'Erva azulada que concentra energia durante a noite. Valiosa em alquimia.', icon: '🍃', category: 'material', rarity: 'uncommon', stackMax: 50, value: 12 },
  ...
  { id: 'oak_arcane_staff', name: 'Cajado de Carvalho Arcano', description: 'Cajado reforçado com prata e Folha Lunar. Amplifica magia ofensiva.', icon: '🪄', category: 'weapon', rarity: 'rare', stackMax: 1, value: 145, equipSlot: 'weapon', stats: { attack: 12, maxHp: 6 }, allowedClasses: ['mage'] },
  ...
  { id: 'forged_guard_armor', name: 'Armadura do Guarda', description: 'Armadura de ferro forjada e reforçada com couro de lobo.', icon: '🛡️', category: 'equipment', rarity: 'rare', stackMax: 1, value: 155, equipSlot: 'armor', stats: { defense: 6, maxHp: 22 }, allowedClasses: ['warrior'] },
