...
export const QUEST_CATALOG: QuestDefinition[] = [
  {
    ...
    objectives: [{ id: 'kill-wolves', type: 'kill', label: 'Derrote Lobos Sombrios', monsterKind: 'wolf', amount: 3 }], rewards: { exp: 60, coins: 30 },
  ...
  },
  {
    ...
    requirements: { completedQuests: ['forest.wolves.v2'] }, objectives: [{ id: 'kill-sludge', type: 'kill', label: 'Derrote Lodos Tóxicos', monsterKind: 'sludge', amount: 4 }], rewards: { exp: 100, coins: 45 },
  ...
  },
  {
    ...
    requirements: { completedQuests: ['forest.wolves.v2'] }, objectives: [{ id: 'deliver-pelts', type: 'deliver', label: 'Entregue Peles de Lobo a Theo', itemId: 'wolf_pelt', npcId: 'theo', amount: 3 }, { id: 'deliver-sludge', type: 'deliver', label: 'Entregue Gosmas Tóxicas a Theo', itemId: 'toxic_sludge', npcId: 'theo', amount: 2 }],
  ...
  },
  {
    ...
    requirements: { completedQuests: ['forest.sludge.v1'] }, objectives: [{ id: 'talk-theo', type: 'talk', label: 'Fale com Theo', npcId: 'theo', amount: 1 }, { id: 'visit-well', type: 'visit', label: 'Visite o poço da Vila da Clareira', target: 'village-well', amount: 1 }, { id: 'touch-shrine', type: 'interact', label: 'Interaja com o Santuário de Renascimento', target: 'respawn-shrine', amount: 1 }],
  ...
  },
  {
    ...
    requirements: { completedQuests: ['forest.wolves.v2'] }, objectives: [{ id: 'gather-iron', type: 'gather', label: 'Minere Veios de Ferro 2 vezes', itemId: 'iron_ore', amount: 2 }, { id: 'craft-ingot', type: 'craft', label: 'Refine 1 Lingote de Ferro', target: 'refine-iron-ingot', itemId: 'iron_ingot', amount: 1 }],
  ...
  },
  {
    ...
    requirements: { completedQuests: ['village.arcane-route.v1'] }, objectives: [{ id: 'gather-herbs', type: 'gather', label: 'Colete Ervas-da-Clareira 2 vezes', itemId: 'healing_herb', amount: 2 }, { id: 'craft-potion', type: 'craft', label: 'Prepare 1 Poção Pequena de Vida', target: 'alchemy-small-potion', itemId: 'small_health_potion', amount: 1 }],
